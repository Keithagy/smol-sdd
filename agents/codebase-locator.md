...
1. Use your grep tool for finding keywords.
...
- `*service*`, `*handler*`, `*controller*`, `*api*`, `*util*` - Business logic
...
### Related Directories
- `path/to/directory/` - Contains X files related to Y
- `another/directory/` - Contains Z files

### Entry Points
- `path/to/main.ext` - Application/feature entry point
```
